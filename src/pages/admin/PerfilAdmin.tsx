...
export default function PerfilUsuario() {
  ...
  const validateDocumento = () => {
    ...
    if (!raw) return "Preencha seu CNPJ.";

    const onlyDigits = raw.replace(/\D/g, "");
    if (onlyDigits.length !== 14) return "CNPJ inválido: deve ter 14 dígitos.";
  ...
  const validate = () => {
    ...
    const errCnpj = validateDocumento();
    if (errCnpj) return errCnpj;
        ...
        <div className="rounded-2xl border border-muted/20 bg-white shadow-sm p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label htmlFor="telefone" className="text-sm text-secondary font-medium">
                  Telefone
                </label>
                <div className="relative">
                  <PhoneIcon
