      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 mb-7">
          ...
          <div className="flex items-center gap-2">
            <Link to="/solicitacoes" className="h-11 px-4 rounded-xl border border-muted/30 bg-white hover:bg-dark/5 transition inline-flex items-center gap-2 text-sm font-medium">
